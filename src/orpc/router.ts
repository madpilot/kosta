...
export const router = {
  ...
  calendar: {
    ...
    byPlant: os
      .route({
        method: 'GET',
        path: '/api/calendar/plants/{plantId}',
    ...
    dailySchedule: os
      .route({
        method: 'GET',
        path: '/api/calendar/daily-schedule/{date}',
